...
//Draw a background rectangle for map
  ...
  Promise.all([
    ...
    chart1.append("text").text("Air Pollution Percentile")
        .attr("transform", "translate(57.625, 490)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart1.append("text").text("0")
        .attr("transform", "translate(17, 538)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart1.append("text").text("100")
