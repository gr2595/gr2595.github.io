(function() {
  ...
  const g3 = chart3.append('g'); 

  chart3.call(d3.zoom().on('zoom', () => {
            ...
            .attr("fill",function(d){
              ...
              if(data[zipcode]==undefined){
                ...
                //console.log(data[zipcode]["Deaths_By_Stroke"])
                  ...
                  var asthma = data[zipcode]["Asthma_Pctl"]
                  //return colorScale(strokedeaths)
                  return colorScale(asthma)
              }
...
// Visual Cinnamon Legend: https://www.visualcinnamon.com/2016/05/smooth-color-legend-d3-svg-gradient.html
    ...
    chart3.append("text").text("Asthma Percentile")
        .attr("transform", "translate(71.43, 490)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart3.append("text").text("0")
        .attr("transform", "translate(17, 538)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart3.append("text").text("100")
