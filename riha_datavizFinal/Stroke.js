(function() {  
  ...
  const g5 = chart5.append('g'); 

  chart5.call(d3.zoom().on('zoom', () => {
    g5.attr('transform', d3.event.transform);
  }));
            ...
            .attr("fill",function(d){
              ...
              if(data[zipcode]==undefined){
                ...
                //console.log(data[zipcode]["Deaths_By_Stroke"])
                  ...
                  var stroke = data[zipcode]["Stroke_Pctl"]
                  //return colorScale(strokedeaths)
                  return colorScale(stroke)
              }
...
// Visual Cinnamon Legend: https://www.visualcinnamon.com/2016/05/smooth-color-legend-d3-svg-gradient.html
    ...
    chart5.append("text").text("Deaths Caused by Stroke Percentile")
        .attr("transform", "translate(25.915, 490)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart5.append("text").text("0")
        .attr("transform", "translate(17, 538)")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart5.append("text").text("100")
