(function() {  
  ...
  const g4 = chart4.append('g'); 

  chart4.call(d3.zoom().on('zoom', () => {
    g4.attr('transform', d3.event.transform);
  }));
            ...
            .attr("fill",function(d){
              ...
              if(data[zipcode]==undefined){
                ...
                //console.log(data[zipcode]["Deaths_By_Stroke"])
                  ...
                  var heartdisease = data[zipcode]["Heart_Disease_Pctl"]
                  //return colorScale(strokedeaths)
                  return colorScale(heartdisease)
              }
...
// Visual Cinnamon Legend: https://www.visualcinnamon.com/2016/05/smooth-color-legend-d3-svg-gradient.html
    ...
    chart4.append("text").text("Deaths Caused by Heart Disease Percentile")
        .attr("transform", "translate(5.85, 490)")
        .attr("font-family", "palatino")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart4.append("text").text("0")
        .attr("transform", "translate(17, 538)")
        .attr("font-size", "12px")
        .attr("fill", "grey");

    chart4.append("text").text("100")
